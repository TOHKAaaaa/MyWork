...
# model = torch.load('fruit_model_10(SVM).pth',map_location = torch.device('cpu'))
model = torch.load('fruit_model_2(SVM).pth',map_location = torch.device('cpu'))
# model = torch.load('model_new(final).pth',map_location = torch.device('cpu'))
model.eval()
print("load finished!")
