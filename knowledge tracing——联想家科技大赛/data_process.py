...
# 读入训练集
with open('Task2_data_0804/Task2_data_0804/problem_act_train.json', 'r', encoding='utf8') as fi1:
    for line in fi1:
        item = json.loads(line)
        train_item.append(item)

with open('Task2_data_0804/Task2_data_0804/problem_act_train_2.json', 'r', encoding='utf8') as fi2:
    for line in fi2:
        item = json.loads(line)
        train_item.append(item)
...
# 读入测试集
test_item = []
with open('Task2_data_0804/Task2_data_0804/problem_act_test_new.json', 'r', encoding='utf8') as fi2:
    for line in fi2:
        item = json.loads(line)
...
problem2id = {}  # 存储id 字典
idx = 0
with open('Task2_data_0804/Task2_data_0804/problem_info.json', 'r', encoding='utf8')as fi:
    for line in fi:
        item = json.loads(line)
